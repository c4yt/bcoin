...
class FullNode extends Node {
  ...
  async getMetaByAddress(addrs) {
    ...
    // TODO: Fix this hack
    if (this.plugins.indexer.idb.has('addrindexer')) {
      const indexer = await this.plugins.indexer.idb.getMetaByAddress(addrs);
      return chain.concat(indexer);
    }
  ...
  async getMeta(hash) {
    ...
    // TODO: Fix this hack
    if (this.plugins.indexer.idb.has('txindexer'))
      return this.plugins.indexer.idb.getMeta(hash);
